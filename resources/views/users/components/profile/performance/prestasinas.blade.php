...
<div class="profile-about" id="profile-about">
    ...
    <div id="header-profil">
        <div class="container">
            <h1>Prestasi Tingkat Nasional SD YPKP 2 Sentani</h1>
        </div>
    </div>

    <div id="presnas-items">
        <div class="container">

            @foreach ($presnas as $pk)
                <div class="presnas">
                    <div class="presnas-img">
                        <img src="{{ asset('storage/'.$pk->img_name) }}" alt="">
                    </div>
                    <div class="presnas-item">
                        <div class="presnas-name">
                            <h5>{{ $pk->name}}</h5>
                        </div>
                        <div class="presnas-level">
