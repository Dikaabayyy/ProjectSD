...
<div class="profile-about" id="profile-about">
    ...
    <div id="header-profil">
        <div class="container">
            <h1>Prestasi Tingkat Kabupaten/Kota SD YPKP 2 Sentani</h1>
        </div>
    </div>

    <div id="preskab-items">
        <div class="container">

            @foreach ($preskab as $pk)
                <div class="preskab">
                    <div class="preskab-img">
                        <img src="{{ asset('storage/'.$pk->img_name) }}" alt="">
                    </div>
                    <div class="preskab-item">
                        <div class="preskab-name">
                            <h5>{{ $pk->name}}</h5>
                        </div>
                        <div class="preskab-level">
