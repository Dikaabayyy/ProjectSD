            ...
            <div class="card-body">
                ...
                <div >
                    <ul class="nav nav-tabs nav-tabs-bordered">
                        <li class="nav-item">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#class-1a">Kelas 1 A</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#class-1b">Kelas 1 B</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#class-1c">Kelas 1 C</button>
                        </li>
                      </ul>
                </div>
                ...
                <div class="tab-content pt-2">
                    ...
                    <div class="tab-pane fade show active class-1a pt-3" id="class-1a">
                    ...
                    <div class="tab-pane fade show class-1b pt-3" id="class-1b">
                        <div style="text-align: start; padding-bottom: 20px;">
                    ...
                    <div class="tab-pane fade show class-1c pt-3" id="class-1c">
                        <div style="text-align: start; padding-bottom: 20px;">
