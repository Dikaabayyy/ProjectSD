...
@section('title', 'Data Siswa Kelas 3')

@section('content')
    <div class="pagetitle">
      <h1>Data Siswa Kelas 3</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
          <li class="breadcrumb-item"><a href="/adm-data-siswa">Data Siswa</a></li>
          <li class="breadcrumb-item active">Data Siswa Kelas 3</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
          ...
          <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h5 class="card-title">Data Siswa Kelas 3 SD YPKP 2 SENTANI</h5>
                    </div>
                </div>
                <div >
                    <ul class="nav nav-tabs nav-tabs-bordered">
                        <li class="nav-item">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#class-3a">Kelas 3 A</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#class-3b">Kelas 3 B</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#class-3c">Kelas 3 C</button>
                        </li>
                      </ul>
                </div>
                ...
                <div class="tab-content pt-2">
                    ...
                    <div class="tab-pane fade show active class-3a pt-3" id="class-3a">
                    ...
                    <div class="tab-pane fade show class-3b pt-3" id="class-3b">
                        <div style="text-align: start; padding-bottom: 20px;">
                    ...
                    <div class="tab-pane fade show class-3c pt-3" id="class-3c">
                        <div style="text-align: start; padding-bottom: 20px;">
