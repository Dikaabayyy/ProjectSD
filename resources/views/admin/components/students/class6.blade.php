...
@section('title', 'Data Siswa Kelas 6')
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Data Siswa Kelas 6</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
          ...
          <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h5 class="card-title">Data Siswa Kelas 6 SD YPKP 2 SENTANI</h5>
                    </div>
                </div>
                <div >
                    <ul class="nav nav-tabs nav-tabs-bordered">
                        <li class="nav-item">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#class-6a">Kelas 6 A</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#class-6b">Kelas 6 B</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#class-6c">Kelas 6 C</button>
                        </li>
                      </ul>
                </div>
                ...
                <div class="tab-content pt-2">
                    ...
                    <div class="tab-pane fade show active class-6a pt-3" id="class-6a">
                    ...
                    <div class="tab-pane fade show class-6b pt-3" id="class-6b">
                        <div style="text-align: start; padding-bottom: 20px;">
                    ...
                    <div class="tab-pane fade show class-6c pt-3" id="class-6c">
                        <div style="text-align: start; padding-bottom: 20px;">
