                ...
                <div class="card-body pt-3">
                    ...
                    <form action="/adm-update-data-agenda-{{ $agenda->slug }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input name="agenda_start" type="date" class="form-control" id="agenda-start" style="width: 200px;" value="{{ $agenda->agenda_start }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input name="agenda_end" type="date" class="form-control" id="agenda_end" style="width: 200px;" value="{{ $agenda->agenda_end }}">
                            </div>
                        </div>
